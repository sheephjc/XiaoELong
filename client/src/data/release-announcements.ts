    ...
    sections: [
      {
        title: "新增",
        items: [
          "为 HJC、HSX、mx、chui、郭、HF 与 A神加入生日祝福：生日当天首次打开左键面板会优先显示专属贺卡。",
          "关闭贺卡后，当天仍会在面板中保留生日祝福、彩带、蛋糕雨与升空烟花；动画层不会阻挡聊天、每日一题、神选或五子棋操作。",
          "生日贺卡按年份和日期记录已读状态，当天关闭后不再弹出，下一年生日会再次送上祝福。"
        ]
      },
      {
        title: "调整",
        items: [
          "生日祝福标题改为中文与 HAPPY BIRTHDAY 同行等大展示，并优化无边框关闭按钮与面板内排版。",
          "面板普通文字不再被鼠标框选，聊天输入框等可编辑区域仍保留正常文字编辑能力。",
          "心情选择器与桌宠心情气泡提升显示层级，不再被聊天面板遮挡。"
        ]
      },
      {
        title: "修复",
        items: [
          "聊天列表在图片或内容布局变化后会继续贴住底部；用户主动滚动、触摸或按下列表时会立即停止待执行的自动滚动。"
        ]
      },
      {
        title: "说明",
